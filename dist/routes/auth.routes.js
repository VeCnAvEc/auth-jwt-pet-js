...
router.post("/logoutAll", auth_middleware_1.default, auth_controller_1.default.logoutAll);
router.get("/me", auth_middleware_1.authMiddleware, auth_controller_1.default.me);
